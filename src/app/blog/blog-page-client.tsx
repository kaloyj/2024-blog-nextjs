...
export default function BlogPageClient({ featuredPost, regularPosts }: BlogPageClientProps) {
  return (
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-dark-300 max-w-2xl mx-auto">
              Thoughts on development, technology, personal projects, and life experiences. A mix of technical insights and personal reflections.
            </p>
          </motion.div>
        </div>
      </section>
