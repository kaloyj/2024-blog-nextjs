        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="mb-6">
                <div className="h-32 bg-gradient-to-br from-primary-600 to-primary-800 rounded-lg mb-4"></div>
                ...
                <p className="text-dark-300 text-sm leading-relaxed mb-4">
                  Exploring the latest React patterns and best practices that will shape 
                  frontend development in 2025, including Server Components and concurrent features.
                </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-dark-300 text-lg">
              Thoughts on development, technology, and the web
            </p>
          </motion.div>
